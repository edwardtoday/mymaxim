jQuery(function($)
{
  function init()
  {
    var arrMaximDefault = [
      ...
      "现阶段我国主要矛盾真是“人民群众日益增长的维权意识和停滞不前的独立思考能力以及常识缺失间的矛盾”。	@严同",
      "那些靠着贪腐欺骗和箝制异己保住权势的人，须知你门站在历史错误的一边，而只要你愿意松手，我们就会帮忙。	@奥巴马",
      "社交网络的一个很大的问题就是，你会慢慢取关那些和你的观念尤其是三观不相符的人，慢慢的你的身边聚集的就只剩下与你三观一致的人，这时候你就会觉得自己的三观是社会的主流，是正确的，但很多时候，这样的认为是危险的。",
